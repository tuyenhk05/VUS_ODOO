...
5. **`vus_attendance`**: Quản lý điểm danh học viên.
   - Định nghĩa bảng điểm danh hàng ngày `vus.attendance` liên kết với lớp và phiếu ghi danh của học viên. Tích hợp lịch sử điểm danh trực quan ngay trên tab thông tin của phiếu ghi danh.
